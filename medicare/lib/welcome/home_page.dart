      ...
      theme: ThemeData(
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            primary: Colors.purple, // Purple background color for buttons
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Welcome Student_Name'),
      ),
...
class ConsultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Consult Page'),
      ),
      body: Center(
        child: Text('This is the Consult Page content.'),
      ),
    );
  }
}
...
class AppointmentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('This is the Appointment Page content.'),
      ),
    );
  }
}
